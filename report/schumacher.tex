...
A recursion depth of 1 yields slightly better results, we now see objects that are opaque and specular since rays are allowed to bounce once before termination.
Notice that the glass sphere is still void of indirect illumination since a succesful refraction involves at least 3 recursive iterations.
...
\begin{figure}
	...
	~
	\begin{subfigure}[h]{0.5\textwidth}
                \includegraphics[width=\textwidth]{figures/recursive_depth/recursion-6-100rpp.png}
