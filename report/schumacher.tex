...
When calculating refractions, Snell's law is used. It states that the product of the refractive indices and sines of the angles must be equal, as stated in \autoref{eq:snell}.\\
