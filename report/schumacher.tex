...
The specular term uses the direction that a perfect reflection from the light source would take on the surface $\emph{herp}$ together with a ray towards the viewer $derp$.
\\
...
A sphere is defined by a position vector and a radius scalar.
