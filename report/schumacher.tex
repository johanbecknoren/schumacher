...
We have also shown that this structure does implies a overhead for images that is too simple.
...
But because the speed gained from complex scenes is far greater then the time lost when dealing with complex scenes, this is still acceptable for us.\\
