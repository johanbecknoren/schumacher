...
\usepackage{graphicx, url, placeins, algorithm, algorithmic, hyperref, amsmath, lipsum, cite}
...
Since the radiosity method handles diffuse reflections rather well, and a Monte Carlo method handles specular reflections, color bleeding etc. a lot of research has been done to find ways to combine these two methods.
...
The resulting equations have two ways to be undefined and if either of these two cases occur, the ray is not intersecting.
The first case is if $B^2 - 4 A C < 0$ 
